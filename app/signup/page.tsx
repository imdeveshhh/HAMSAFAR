...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        toast({
          title: "Welcome to HAMSAFAR!",
          description: "Your travel buddy account has been created successfully.",
        })
          ...
          <div className="max-w-md w-full mx-4">
            <Card className="retro-card border-vintage-orange shadow-2xl bg-white bg-opacity-95 backdrop-blur-sm">
              <CardHeader className="text-center pb-8">
                ...
                <CardTitle className="font-cinzel text-3xl font-bold text-vintage-orange">Join HAMSAFAR</CardTitle>
                <p className="font-garamond text-lg text-orange-800 mt-2">Create your travel buddy account</p>
              </CardHeader>
              ...
              <CardContent className="px-8 pb-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <label className="block font-garamond font-bold text-orange-800 mb-2">Full Name</label>
                    <div className="relative">
                      <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-orange-600 h-5 w-5" />
                      <Input
                        type="text"
                        name="name"
                        value={formData.name}
                  ...
                  <div>
                    <label className="block font-garamond font-bold text-orange-800 mb-2">Confirm Password</label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-orange-600 h-5 w-5" />
                      <Input
                  ...
                  <div className="flex items-start space-x-2">
                    <Checkbox
                      ...
                      className="border-vintage-orange mt-1"
                    />
                    <label htmlFor="terms" className="font-garamond text-sm text-orange-800 leading-relaxed">
                      I agree to the{" "}
                      <Link href="/terms" className="text-vintage-orange hover:text-orange-600 underline">
                        Terms of Service
                      </Link>{" "}
                      and{" "}
                      <Link href="/privacy" className="text-vintage-orange hover:text-orange-600 underline">
                        Privacy Policy
                      </Link>
                    </label>
                  </div>
                ...
                <div className="mt-8 pt-8 border-t-2 border-vintage-orange border-dashed">
                  <p className="text-center font-garamond text-sm text-orange-700 italic">
                    "Every journey begins with a trusted companion"
                  </p>
                </div>
              </CardContent>
            </Card>
